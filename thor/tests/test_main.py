...
from ..main import rangeAndShift
...
def test_rangeAndShift():
    ...
    preprocessed_associations = preprocessed_associations[~preprocessed_associations["obs_id"].isin(noise_ids)]
    ...
    for i in range(len(orbits)):
        ...
        gnomonic_offset = np.linalg.norm(analyis_projected_observations[observations_mask][["theta_x_deg", "theta_y_deg"]].values, axis=1)
